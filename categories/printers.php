    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li>
                    <a href="desktop.php">Komputery stacjonarne <?php echo "<span class='span-num-records'>(". getNumberTable('desktop').")</span>"; ?></a>
                </li>
                <li>
                    <a href="printers.php">Drukarki <?php echo "<span class='span-num-records'>(". getNumberTable('printers').")</span>"; ?></a>
                </li>
                <li>
                    <a href="laptop.php">Laptopy <?php echo "<span class='span-num-records'>(". getNumberTable('laptop').")</span>"; ?></a>
                </li>
                <li>
                    <a href="software.php">Software <?php echo "<span class='span-num-records'>(". getNumberTable('software').")</span>"; ?></a>
                </li>
                <li>
                    <a href="tablet.php">Tablet <?php echo "<span class='span-num-records'>(". getNumberTable('tablet').")</span>"; ?></a>
                </li>
                <li>
                    <a href="akcesoria.php">Akcesoria <?php echo "<span class='span-num-records'>(". getNumberTable('akcesoria').")</span>"; ?></a>
                </li>
...
<?php
    ...
    if ($stmt= $mysqli->query("select * from printers ")){
      ...
      while($row = $stmt->fetch_array())
        {
            ...
            echo "<div class=\"wrap-cat-buy\">";
            echo "<a href='podglad.php?tablica=".serialize($row)."'>";
                echo "<img src='$path' class=\"img-cat-buy\"/>";
            echo "</a>";

                echo "<div class=\"opis-cat-buy\">";
                  echo $row['nazwa'];
                  echo "<br>";
                  echo $row['cena']." PLN";
                  echo "<br>";
                  echo "<a href='pelenopis.php?tablica=".serialize($row)."'>Pelen opis";
                  echo "</a>";
                echo "</div>";
                // for 662px
                echo "<div class=\"opis-cat-buy-media\">";
                  echo $row['nazwa'];
                  echo "<br>";
